...
<div class="header">
    <div class="logo">
        ...
        <a href="./" style="font-weight: 900;">
            <!-- <lord-icon class="img" src="https://cdn.lordicon.com//eqwebkyi.json" trigger="loop" colors="primary:#ff6a00,secondary:#0e121b" stroke="79" style="width:70px;height:70px">
            </lord-icon> -->
            <svg style="transform:scale(0.8)" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="51.463px" height="51.463px" viewBox="0 0 51.463 51.463" style="enable-background:new 0 0 51.463 51.463;" xml:space="preserve">
                <g>
                    <g>
    ...
    <ul class="nav-links">
        <li class="nav-link"><a href="./">Acasă</a></li>
        <li class="nav-link"><a href="./#contact">Despre Noi</a></li>
        <li class="nav-link"><a href="./figurine.php">Figurine</a></li>
        <?php
        ...
        if ($user->isLoggedIn()) {
            ...
            echo "
            <li class='nav-link'><a href='./register.php'>Înregistrează-te</a></li>
            <li class='nav-link'><a href='./login.php'>Intră în cont</a></li>";
        }
        ?>
        <li class="nav-link"><a href="./cos.php" style="
        padding: 20px;
        ">
                <?php
                if (Cos::Exists()) {
                    if (count(Cos::GetProduse()))
                        echo '<span>' . count(Cos::GetProduse()) . '</span>';
                }
                ?>
                Cos</a></li>

        <!-- <li class="nav-link"> <a href="https://www.facebook.com/florariadelaparc/">
                <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="white">
                    <path fill="black" d="M22,12c0-5.52-4.48-10-10-10S2,6.48,2,12c0,4.84,3.44,8.87,8,9.8V15H8v-3h2V9.5C10,7.57,11.57,6,13.5,6H16v3h-2 c-0.55,0-1,0.45-1,1v2h3v3h-3v6.95C18.05,21.45,22,17.19,22,12z" />
                </svg>
            </a></li>
        <li class="nav-link">
            <a href="https://www.instagram.com/florariadelaparc/">
